import{Lt as V$1,X as Le,br as me,hn as co,hr as le,ii as uo,mi as wt,yi as xc}from"./chunk-CL6JGEkq.js";var M=(()=>{class s{_animationsDisabled=co();state=`unchecked`;disabled=!1;appearance=`full`;static ɵfac=function(o){return new(o||s)};static ɵcmp=Le({type:s,selectors:[[`mat-pseudo-checkbox`]],hostAttrs:[1,`mat-pseudo-checkbox`],hostVars:12,hostBindings:function(o,i){o&2&&wt(`mat-pseudo-checkbox-indeterminate`,i.state===`indeterminate`)(`mat-pseudo-checkbox-checked`,i.state===`checked`)(`mat-pseudo-checkbox-disabled`,i.disabled)(`mat-pseudo-checkbox-minimal`,i.appearance===`minimal`)(`mat-pseudo-checkbox-full`,i.appearance===`full`)(`_mat-animation-noopable`,i._animationsDisabled)},inputs:{state:`state`,disabled:`disabled`,appearance:`appearance`},decls:0,vars:0,template:function(o,i){},styles:[`.mat-pseudo-checkbox {
  border-radius: 2px;
  cursor: pointer;
