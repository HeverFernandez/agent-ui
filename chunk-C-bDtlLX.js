...
`],encapsulation:2})}return i})();var ce=(()=>{class i{static ɵfac=function(t){return new(t||i)};static ɵmod=me({type:i});static ɵinj=le$1({imports:[tb,rt,ro]})}return i})();var qt=(()=>{class i{static ɵfac=function(t){return new(t||i)};static ɵcmp=Fe({type:i,selectors:[[`ng-component`]],hostAttrs:[`cdk-text-field-style-loader`,``],decls:0,vars:0,template:function(t,n){},styles:[`textarea.cdk-textarea-autosize {
  resize: none;
}
